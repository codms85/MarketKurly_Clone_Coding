      ...
      <div class="main_contents">
        <div class="MAIN_BENNERS">
          <div class="benner_out">
            <div class="benner_in">
              <ul class="slides">
                <li><img src="https://product-image.kurly.com/cdn-cgi/image/format=auto/banner/main/pc/img/4c2d896f-d15c-4de8-8eb6-8315646462c2.jpg" alt="" /></li>
              </ul>
            </div>
            <button class="benner_btn_left" direction="left"></button>
            <button class="benner_btn_right" direction="right"></button>
          </div>
        </div>
